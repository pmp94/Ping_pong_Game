...
function init() {
    ...
    if (canvas.getContext) {
        ...
        leftPaddle = makeRect(25, canvas.height / 2 - paddleHeight / 2, paddleWidth, paddleHeight, 5, '#ff9900'); // left paddle color
        rightPaddle = makeRect(canvas.width - paddleWidth - 25, canvas.height / 2 - paddleHeight / 2, paddleWidth, paddleHeight, 5, '#339933'); // right paddle color
        ball = makeRect(0, 0, ballSize, ballSize, ballSpeed, '#ff3300'); // change ball color
...
setTimeout(function(){ leftScore = 0;
rightScore = 0; }, 3000);
exit;
}
function drawScores() {
...
<center>
    ...
    <main>
        <canvas id="board" width="600px" height="750px" style="border: 1px solid black;">
